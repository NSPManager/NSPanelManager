...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \begin{itemize}
      ...
      \item First of all, enter the connection details to the manager. This data is supplied to NSPanels when the try to find managers over the network. 
      \item In the "Manager address"-field, enter the IP-address used to connect to the manager.
      \item In the "Manager port"-field, enter the port used to connect to the manager. If you didn't change the port, this is 8000.
      \item Enter connection details for your MQTT server, leave username and password empty if you do not use MQTT authentication.
       \note{If you are running the MQTT server as an add-on to Home Assistant, enter the IP-address of your Home Assistant server.}
      \item If you wish to use NSPanel Manager with Home Assistant, enter the connection details in the "Home Assistant API"-section. Enter the address with http or https and port, E.g. \textit{http://192.168.1.5:8123}. Also enter Home Assistant access token.
      ...
      \item If you wish to use NSPanel Manager with OpenHAB, enter the connection details in the "OpenHAB API"-section. Enter the address with http or https and port, E.g. \textit{http://192.168.1.5:8123}. Also enter OpenHAB access token.
    ...
    \\
    Next we will need to figure out what location ID to use to gather weather information for your location. The easiest way of doing this is to go to \href{https://accuweather.com}{AccuWeather} and locate your city.
