...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \begin{itemize}
      ...
      \item \textbf{For both git and zip-download}, navgiate to the "docker"-directory and run \lstinline[language=bash]{bash docker-stop\_and\_rm.sh} to stop and remove the current container. Once that is done, run \lstinline[language=bash]{docker-build\_and\_run.sh} to build and start the new container.
    \end{itemize}
