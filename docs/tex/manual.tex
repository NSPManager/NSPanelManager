...
\begin{document} % All begin commands must be paired with an end command somewhere
    ...
    \\
    Next create two items to connect to the two things in the things file, either via openhab web interface or textual configuration.
    If using textual configuration you can add this to your item file:
    \begin{lstlisting}
    String Accu_Weather_Current     "Accu Weather Current"  ["Point"]   { channel="http:url:accu_weather:weather" }
String Accu_Weather_Forecast    "Accu Weather Forecast" ["Point"]	{ channel="http:url:accu_forecast:forecast" }
    \end{lstlisting}
    
    Once this is done and the weather HTTP-binding is showing up in OpenHAB you can press the "Select weather entity" in the NSPanel Manager web interface, select your weather entity and then select the items for current weather and forecast.
    \\
