...
class Light:
    ...
    def set_color_temp(self, color_temp: int):
        ...
        if self.can_color_temperature and self.light_level > 0:
            if self.type == "home_assistant":
                mqtt_manager_libs.home_assistant.set_entity_color_temp(self.home_assistant_name, color_temp)
            elif self.type == "openhab":
                mqtt_manager_libs.home_assistant.set_entity_color_temp(self.openhab_item_color_temp, color_temp)
