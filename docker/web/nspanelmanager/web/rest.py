    ...
    if request.method == "GET":
        ...
        for nspanel in nspanel_objects:
            nspanels.append({
                ...
                "button1_detached_light": nspanel.button1_detached_mode_entity.id if nspanel.button1_detached_mode_entity else -1,
                "button2_detached_light": nspanel.button2_detached_mode_entity.id if nspanel.button2_detached_mode_entity else -1,
