...
@component.register("nspanel_status_pressure")
class NSPanelStatusPressure(component.Component):
    template_view = None
    ...
    def get_template_name(self, context: Context):
        ...
        if url_name == "edit_nspanel":
            return "nspanel_status_pressure/nspanel_status_pressure_edit_nspanel.html"
