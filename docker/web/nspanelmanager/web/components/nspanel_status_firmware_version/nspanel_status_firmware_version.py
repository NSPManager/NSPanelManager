...
@component.register("nspanel_status_firmware_version")
class NSPanelStatusFirmwareVersion(component.Component):
    template_view = None
    ...
    def get_template_name(self, context: Context):
            ...
            if url_name == "htmx_partial_index_nspanels_section" or url_name == "index":
                return "nspanel_status_firmware_version/nspanel_status_firmware_version_index.html"
            elif url_name == "edit_nspanel":
                return "nspanel_status_firmware_version/nspanel_status_firmware_version_edit_nspanel.html"
