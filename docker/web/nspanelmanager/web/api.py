...
def get_nspanel_config(request):
    try:
        ...
        base["show_screensaver_clock"] = get_nspanel_setting_with_default(nspanel.id, "show_screensaver_clock", get_setting_with_default("show_screensaver_clock", "True"))
        base["show_screensaver_background"] = get_nspanel_setting_with_default(nspanel.id, "show_screensaver_background", get_setting_with_default("show_screensaver_background", "True"))
