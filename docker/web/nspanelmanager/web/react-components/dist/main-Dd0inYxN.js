const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["EntitiesPagesView-BRjeAZoK.js","MultiStep_AddEditEntity-CSljAlTX.js"])))=>i.map(i=>d[i]);
...
var componentMap = {
	MultiStep_AddEditEntity: (0, import_react.lazy)(() => __vitePreload(() => import("./MultiStep_AddEditEntity-CSljAlTX.js").then((n) => n.t), [])),
	EntitiesPagesView: (0, import_react.lazy)(() => __vitePreload(() => import("./EntitiesPagesView-BRjeAZoK.js"), __vite__mapDeps([0,1])))
};
//#endregion
