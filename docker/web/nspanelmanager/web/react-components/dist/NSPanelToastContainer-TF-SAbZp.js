...
`,tt=new Map,Yt=(t,e)=>{lt(()=>{if(!t||typeof document>"u")return;let o=document,a=tt.get(o);if(a){e&&a.setAttribute("nonce",e);return}let r=o.createElement("style");r.textContent=t,e&&r.setAttribute("nonce",e),o.head.appendChild(r),tt.set(o,r)},[e])};function Qt(t){return Yt(Kt,t.nonce),i.createElement(qt,{...t})}var ae=yt({CustomToast:()=>ct,Notify:()=>Wt,RemoveNotification:()=>Vt,default:()=>Jt}),W=pt(),Vt=t=>{_.dismiss(t)},Wt=({message:t,level:e,duration:o,toast_id:a})=>{let r="default";e==="error"&&(r="error"),e==="warning"&&(r="warning"),e==="info"&&(r="info"),e==="debug"&&(r="default"),e==="success"&&(r="success"),_(ct,{autoClose:o??!1,type:r,theme:"colored",icon:!1,data:{message:t,level:e},toastId:a})},ct=({data:t})=>(0,W.jsx)("div",{className:"pl-1 py-2 me-6",children:(0,W.jsx)("p",{children:t.message})}),Gt={success:"bg-success text-success-content",error:"bg-error text-error-content",info:"bg-info text-info-content",warning:"bg-warning text-warning-content",default:"bg-neutral text-neutral-content"};function Jt(){return(0,W.jsx)(Qt,{position:"bottom-right",autoClose:5e3,hideProgressBar:!1,newestOnTop:!1,closeOnClick:!1,rtl:!1,pauseOnFocusLoss:!0,draggable:!0,pauseOnHover:!0,theme:"light",transition:ft,toastClassName:t=>Gt[t?.type||"default"]+" relative flex min-w-84 p-1 min-h-10 rounded-md justify-between overflow-hidden cursor-pointer my-2",progressClassName:"progress",className:""})}export{Wt as n,Vt as r,ae as t};
