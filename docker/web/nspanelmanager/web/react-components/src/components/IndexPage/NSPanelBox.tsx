...
const AcceptedNSPanelContent = ({ status }: { status: INSPanelStatusData }) => {
  ...
  return (
    <>
      <div className="relative h-full group/box" ref={boxRef}>
        <motion.div
          style={{ WebkitMaskImage: clipPath, maskImage: clipPath, pointerEvents: "none" }}
        ...
        >
          <div className="grid grid-cols-8 w-full h-full inset-0">
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-2s] tile-1 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-6s] tile-2 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-4s] tile-3 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-8s] tile-4 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-4s] tile-1 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-2s] tile-2 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-8s] tile-3 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-2s] tile-4 group/box:opacity-50`}
            ></div>
            ...
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-8s] tile-2 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-6s] tile-3 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-4s] tile-4 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-8s] tile-1 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-6s] tile-2 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-2s] tile-3 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-4s] tile-4 group/box:opacity-50`}
            ></div>
            ...
            <div
              className={`w-full h-full col-span-4 ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-6s] tile-1 group/box:opacity-50`}
            ></div>
            <div
              className={`w-full h-full col-span-4 ${status.state == "offline" ? "bg-error" : "bg-accent"} [animation-name:tile-background] [animation-duration:8s] [animation-iteration-count:infinite] opacity-0 [animation-delay:-2s] tile-2 group/box:opacity-50`}
            ></div>
          </div>
