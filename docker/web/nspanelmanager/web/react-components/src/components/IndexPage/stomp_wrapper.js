...
export function stomp_connected_callback() {
...
export function stomp_send(destination, message) {
...
export function stomp_disconnected_callback() {
  console.log("Disconnected from STOMP.");
  $("#ws_connection_in_progress_notification").removeClass("hidden");
}

export function stomp_websocket_close_callback() {
  console.log("Disconnected from STOMP (websocket closed).");
  // $("#ws_connection_in_progress_notification").removeClass("hidden");
}

export function stomp_websocket_error_callback() {
  console.log("Disconnected from STOMP (websocket error).");
  $("#ws_connection_in_progress_notification").removeClass("hidden");
}

export function stomp_error_callback(error) {
  console.error("STOMP error:", error);
}

export function stomp_subscribe(topic, callback) {
...
export function stomp_unsubscribe(topic, callback) {
