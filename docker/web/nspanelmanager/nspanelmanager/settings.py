...
STATICFILES_DIRS = [os.path.join(BASE_DIR, "web/components"), os.path.join(BASE_DIR, "web/react-components/dist")]
...
TEMPLATES = [
    {
        ...
        "DIRS": [os.path.join(BASE_DIR, "web/templates"), os.path.join(BASE_DIR, "web/react-components/templates")],
        "OPTIONS": {
            "context_processors": [
