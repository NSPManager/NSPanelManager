(define (nspanel-us-tft4 xcf-path)
  (let* (
...
;; THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE   	
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft4/180_thermostat_background.bmp" "pictures_tft4/180_thermostat_background.bmp")
		)
	(gimp-image-delete newImage)
	)
...
(script-fu-register "nspanel-us-tft4"
  _"Export NSPanel US"
