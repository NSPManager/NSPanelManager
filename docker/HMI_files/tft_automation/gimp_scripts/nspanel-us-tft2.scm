(define (nspanel-us-tft2 xcf-path)
  (let* (
	...
	(gimp-item-set-visible (car (gimp-image-get-layer-by-name image "tft2")) 1)
...
;FIRST_PAGE FIRST_PAGE FIRST_PAGE FIRST_PAGE FIRST_PAGE FIRST_PAGE FIRST_PAGE FIRST_PAGE FIRST_PAGE 
		...
		(gimp-item-set-visible (car (gimp-image-get-layer-by-name image "ALARM_PAGE")) 0)
	...
	(gimp-image-merge-visible-layers newImage 1)
		...
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/58_first_page_ON.bmp" "pictures_tft2/58_first_page_ON.bmp")
		)
	...
	(gimp-image-merge-visible-layers newImage 1)
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/57_first_page_OFF.bmp" "pictures_tft2/57_first_page_OFF.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	(gimp-image-merge-visible-layers newImage 1)
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/59_first_page_scenes_room_off.bmp" "pictures_tft2/59_first_page_scenes_room_off.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	(gimp-image-merge-visible-layers newImage 1)
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/60_first_page_scenes_room_on.bmp" "pictures_tft2/60_first_page_scenes_room_on.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	(gimp-image-merge-visible-layers newImage 1)
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/62_first_page_scenes_all_on.bmp" "pictures_tft2/62_first_page_scenes_all_on.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	(gimp-image-merge-visible-layers newImage 1)
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/61_first_page_scenes_all_off.bmp" "pictures_tft2/61_first_page_scenes_all_off.bmp")
		)
	(gimp-image-delete newImage)
	)
...
;; ENTITY_PAGE_4 ENTITY_PAGE_4 ENTITY_PAGE_4 ENTITY_PAGE_4 ENTITY_PAGE_4 ENTITY_PAGE_4 ENTITY_PAGE_4 
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/67_ENTITY_PAGE_4_empty.bmp" "pictures_tft2/67_ENTITY_PAGE_4_empty.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/68_ENTITY_PAGE_4_press.bmp" "pictures_tft2/68_ENTITY_PAGE_4_press.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/73_scenes_page_loadbar_0.bmp" "pictures_tft2/73_scenes_page_loadbar_0.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/74_scenes_page_loadbar_100.bmp" "pictures_tft2/74_scenes_page_loadbar_100.bmp")
		)
	(gimp-image-delete newImage)
	)
...
;; ENTITY_PAGE_8 ENTITY_PAGE_8 ENTITY_PAGE_8 ENTITY_PAGE_8 ENTITY_PAGE_8 ENTITY_PAGE_8 ENTITY_PAGE_8 ENTITY_PAGE_8  	
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/69_ENTITY_PAGE_8_empty.bmp" "pictures_tft2/69_ENTITY_PAGE_8_empty.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/70_ENTITY_PAGE_8_press.bmp" "pictures_tft2/70_ENTITY_PAGE_8_press.bmp")
		)
	(gimp-image-delete newImage)
	)
...
;; ENTITY_PAGE_12 ENTITY_PAGE_12 ENTITY_PAGE_12 ENTITY_PAGE_12 ENTITY_PAGE_12 ENTITY_PAGE_12 ENTITY_PAGE_12 	
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/71_ENTITY_PAGE_12_empty.bmp" "pictures_tft2/71_ENTITY_PAGE_12_empty.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/72_ENTITY_PAGE_12_press.bmp" "pictures_tft2/72_ENTITY_PAGE_12_press.bmp")
		)
	(gimp-image-delete newImage)
	)
...
;; LIGHTS_PAGE LIGHTS_PAGE LIGHTS_PAGE LIGHTS_PAGE LIGHTS_PAGE LIGHTS_PAGE LIGHTS_PAGE LIGHTS_PAGE LIGHTS_PAGE LIGHTS_PAGE 	
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/75_lights_page_empty.bmp" "pictures_tft2/75_lights_page_empty.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/76_lights_page_brightness_off.bmp" "pictures_tft2/76_lights_page_brightness_off.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/78_lights_page_kelvin_off.bmp" "pictures_tft2/78_lights_page_kelvin_off.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/80_lights_page_color_off.bmp" "pictures_tft2/80_lights_page_color_off.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/77_lights_page_brightness_on.bmp" "pictures_tft2/77_lights_page_brightness_on.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/79_lights_page_kelvin_on.bmp" "pictures_tft2/79_lights_page_kelvin_on.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/81_lights_page_color_on.bmp" "pictures_tft2/81_lights_page_color_on.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/82_lights_page_saturation_off.bmp" "pictures_tft2/82_lights_page_saturation_off.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/83_lights_page_saturation_on.bmp" "pictures_tft2/83_lights_page_saturation_on.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/85_lights_page_corner_empty.bmp" "pictures_tft2/85_lights_page_corner_empty.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/86_lights_page_corner_kelvin.bmp" "pictures_tft2/86_lights_page_corner_kelvin.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/87_lights_page_corner_color.bmp" "pictures_tft2/87_lights_page_corner_color.bmp")
		)
	(gimp-image-delete newImage)
	)
...
;; SCREENSAVER_PAGE SCREENSAVER_PAGE SCREENSAVER_PAGE SCREENSAVER_PAGE SCREENSAVER_PAGE SCREENSAVER_PAGE SCREENSAVER_PAGE 
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/63_screensaver_page.bmp" "pictures_tft2/63_screensaver_page.bmp")
		)
	(gimp-image-delete newImage)
	)
...
;; DROPDOWN_PAGE DROPDOWN_PAGE DROPDOWN_PAGE DROPDOWN_PAGE DROPDOWN_PAGE DROPDOWN_PAGE DROPDOWN_PAGE DROPDOWN_PAGE    	
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/64_dropdown_depress.bmp" "pictures_tft2/64_dropdown_depress.bmp")
		)
	(gimp-image-delete newImage)
	)
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/65_dropdown_press.bmp" "pictures_tft2/65_dropdown_press.bmp")
		)
	(gimp-image-delete newImage)
	)
...
;; BACKGROUND_PAGE BACKGROUND_PAGE BACKGROUND_PAGE BACKGROUND_PAGE BACKGROUND_PAGE BACKGROUND_PAGE BACKGROUND_PAGE   	
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/66_background.bmp" "pictures_tft2/66_background.bmp")
		)
	(gimp-image-delete newImage)
	)
...
;; THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE THERMOSTAT_PAGE   	
	...
	((newImage (car (gimp-image-duplicate image))))
		...
		(let*
		((activeLayer (car (gimp-image-get-active-layer newImage))))
		(gimp-file-save RUN-NONINTERACTIVE image activeLayer "pictures_tft2/180_thermostat_background.bmp" "pictures_tft2/180_thermostat_background.bmp")
		)
	(gimp-image-delete newImage)
	)
...
(script-fu-register "nspanel-us-tft2"
  _"Export NSPanel US"
