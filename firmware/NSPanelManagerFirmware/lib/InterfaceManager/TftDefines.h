...
#define ROOM_LIGHT2_LABEL_NAME "Room.device"
#define ROOM_LIGHT3_LABEL_NAME "Room.device"
#define ROOM_LIGHT4_LABEL_NAME "Room.device"
#define ROOM_LIGHT5_LABEL_NAME "Room.device"
#define ROOM_LIGHT6_LABEL_NAME "Room.device"
